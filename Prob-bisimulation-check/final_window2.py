...
class Ui_Final_window(QtWidgets.QWidget):
    ...
    def take_new(self):
        name,done1  =QtWidgets.QInputDialog.getInt(
            self,'Pr02 Edges' , 'Enter the new length of Pr 02 : ')
        if done1 : 
            print("Done  : " ,name)
            self.TTT = name
            self.openWindow()
    ...
    def setupUi(self, Final_window):
        ...
        # self.label.setGeometry(QtCore.QRect(350, 20, 62, 17))
        font = QtGui.QFont()
        ...
        # self.label_2.setGeometry(QtCore.QRect(1000, 20, 71, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pushButton.setGeometry(QtCore.QRect(680, 690, 150, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(838, 690, 150, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, Final_window):
        ...
        Final_window.setWindowTitle(_translate("Final_window", "New result"))
        ...
        self.label_5.setText(_translate("Final_window",
                                        "To show the result, please click on “Show Result” \n" "To end the program, please click on “Exit” "))
